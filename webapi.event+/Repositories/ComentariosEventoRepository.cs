...
namespace webapi.event_.Repositories
{
    public class ComentariosEventoRepository : IComentariosEventoRepository
    {
        ...
        public ComentariosEvento BuscarPorIdUsuario(Guid userId, Guid eventId)
        {
            try
            {
                return _context.ComentariosEvento
                    ...
                    }).FirstOrDefault(c => c.IdUsuario == userId && c.IdEvento == eventId)!;
            }
            catch (Exception)
            {
                throw;
        ...
        public List<ComentariosEvento> ListarComum(Guid eventId)
        {

            try
            {
                return _context.ComentariosEvento
                    .Where(c => c.Exibe == true && c.IdEvento == eventId)
                    .Select(c => new ComentariosEvento
                    {
                        IdComentarioEvento = c.IdComentarioEvento,
                        Descricao = c.Descricao,
        ...
        public List<ComentariosEvento> ListarAdmin(Guid eventId)
        {

            try
            {
                return _context.ComentariosEvento
                    .Where(c => c.IdEvento == eventId)
                    .Select(c => new ComentariosEvento
                    {
                        IdComentarioEvento = c.IdComentarioEvento,
                        Descricao = c.Descricao,
