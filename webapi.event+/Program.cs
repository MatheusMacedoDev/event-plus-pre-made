...
// Content Moderator Configuration
builder.Services.AddSingleton(provider => new ContentModeratorClient(
    new ApiKeyServiceClientCredentials("1b592e5bb9174f8ab785dcbc61da6cdd"))
{
    Endpoint = "https://event-moderator-matheus.cognitiveservices.azure.com/"
}
);
